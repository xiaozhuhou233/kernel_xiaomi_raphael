...
OUTPUT_ZIP="${3:-out/raphael-kamioc-72-84-90hz-ksunext-ak3.zip}"
...
## SOVIET Mod for EvolutionX + Bool-X 90 Hz timing test + KernelSU Next

properties() { '
kernel.string=SOVIET Mod for EvolutionX | KamiOC 72/84/90Hz Test | KernelSU Next
do.devicecheck=1
do.modules=0
do.systemless=1
do.cleanup=1
